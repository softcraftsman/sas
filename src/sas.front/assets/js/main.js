$(function() {
    ...
    //===== Loads config file
    $.getJSON('https://sasfront.blob.core.windows.net/public/config.json', function(config) {
        $('title').html(config.Institution + ' - Storage as a Service');
    ...
    $(window).on('scroll', function (event) {
        ...
        if (scroll < 20) {
            ...
            $(".navbar-area img").attr("src", configGlobal.Logo);
        } else {
