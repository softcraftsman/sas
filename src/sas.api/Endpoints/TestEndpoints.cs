...
//using static sas.api.TopLevelFolders;
...
//        public static async Task<IActionResult> CalculateFolderSize(
//            [HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequest req,
//            ILogger log)
//        {
//            //Extracting body object from the call and deserializing it.
//            var tlfp = await TopLevelFolders.GetTopLevelFolderParameters(req);
//            if (tlfp == null)
